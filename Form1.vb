...
Public Class Form1
    ...
    Dim b As Integer = 0
    Dim c As Integer = 0
    Public Property LinkLabel2 As Object
    ...
    Public Sub GETproxy()
        Try
            ...
            MsgBox(sayac & " Proxies Grabbed", MsgBoxStyle.Information)
    ...
    Private Sub bsave_Click(sender As Object, e As EventArgs) Handles bsave.Click
        Try
            ...
            If ID.ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                Next
                I.Close()
                MsgBox("Proxi : " & LvProxy.Items.Count & vbCrLf & "Local : " & ID.FileName, MsgBoxStyle.Information, "Information")
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Private Sub proxieslist_SelectedIndexChanged(sender As Object, e As EventArgs) Handles proxieslist.SelectedIndexChanged
